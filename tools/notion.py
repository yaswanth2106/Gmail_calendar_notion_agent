"""
Notion MCP Tool — creates tasks in a Notion database.

Requires:
  1. A Notion integration (https://www.notion.so/my-integrations)
  2. A database shared with that integration
  3. NOTION_API_KEY and NOTION_TASKS_DB_ID in .env
"""
...
class NotionCreateTaskTool(MCPTool):
    ...
    def execute(self, **kwargs) -> MCPToolResult:
        ...
        try:
            ...
            # Add description as page content (children blocks)
            children = []
            if task.description:
                children.append(
                    {
            ...
            # 2. Add priority only if it exists and is a select property
            ...
            # 3. Add due date only if it exists
